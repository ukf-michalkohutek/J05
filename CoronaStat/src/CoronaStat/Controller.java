...
public class Controller {
    ...
    private static String parseData(String responseString) {
        try {
            ...
            System.out.println("No info for date.");
        }
        return null;
    }
    ...
    protected void initialize() {
        ...
        countryPicker.getItems().add("GLOBAL");
        try {
            BufferedReader br = new BufferedReader(new FileReader("src\\krajiny.txt"));
    ...
    private void download() {
        date = (datePicker.getValue()!=null) ? datePicker.getValue().toString() : null;
        country = countryPicker.getSelectionModel().getSelectedItem();
